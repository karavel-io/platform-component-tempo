...
To propose a change to this component, first [open an issue](https://github.com/karavel-io/platform-component-tempo/issues/new)
...
Finally [open a pull request](https://github.com/karavel-io/platform-component-tempo/compare/main) from your fork to the `main`
